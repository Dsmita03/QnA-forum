    ...
    const timelineItems = [
        {
            ...
            desc: "Welcome to StackIt!",
            date: new Date(profile.joinedDate).toLocaleDateString(),
        },
        {
            icon: MessageSquare,
            color: "green",
        ...
        },
        {
            ...
            desc: "Providing helpful answers",
            date: "Ongoing",
        },
    ];
                            ...
                            <div className="relative h-40 bg-gradient-to-r from-orange-500 to-amber-500">
                                ...
                                {isEditing && (
                                    <button
                                        ...
                                        className="absolute inset-0 bg-black/20 flex items-center justify-center hover:bg-black/30"
                                    >
                                ...
                                <div className="relative">
                                    ...
                                    {isEditing && (
                                        <button
                                            ...
                                            className="absolute bottom-0 right-0 bg-orange-500 text-white rounded-full p-2 shadow-lg hover:bg-orange-600"
                                        >
                                ...
                                {!isEditing ? (
                                    ...
                                    <div className="space-y-4 mb-6">
                                        <Input
                                            ...
                                            className="text-xl font-bold border-orange-200 focus:border-orange-500"
                                                        ...
                                                        <div key={idx}>
                                                            ...
                                                            !item.editable ? (
                                                                ...
                                                                <Input
                                                                    value={
                                                                        editedProfile[
                                                                            item.label.toLowerCase() as keyof UserProfile
                                                                        ] as string
                                                                    }
                                                                    onChange={(
                                                                        e
