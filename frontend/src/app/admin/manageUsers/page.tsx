...
export default function ManageUsersPage() {
    ...
    useEffect(() => {
       const getAllUsers = async () => {
         try {
           const response = await axios.get("http://localhost:5001/api/auth/all-users",{withCredentials: true});
    ...
    const toggleBan = (id: string) => {
        ...
        // Call API here to update ban status
        try {
            const response = axios.put(
                `http://localhost:5001/api/auth/ban-user/${id}`,{ withCredentials: true }
            )
    ...
    <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
            ...
            <p className="text-gray-600">Manage users, monitor activity, and control access</p>
        </div>
                ...
                <div className="p-6 border-b bg-gradient-to-r from-white to-orange-50/50">
                    <div className="flex flex-col md:flex-row gap-4 items-start md:items-center justify-between">
                        ...
                        <div className="flex items-center gap-2 text-sm text-gray-600 bg-gray-50 px-3 py-2 rounded-lg">
                            ...
                            <span className="font-medium">{paginatedUsers.length}</span>
