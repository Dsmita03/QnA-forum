...
const AskQuestionPage = () => {
  ...
  const questionTips: QuestionTip[] = [
    ...
    },
    {
      ...
      title: "Use Good Tags",
      description: "Relevant tags help the right people find your question",
      color: "bg-purple-50 border-purple-200 text-purple-800"
    }
  ];

  const steps = [
    { label: 'Title', icon: <HelpCircle className="w-4 h-4" />, field: 'title' },
    { label: 'Description', icon: <FileText className="w-4 h-4" />, field: 'description' },
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 px-4 py-10">
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <p className="text-gray-600 text-lg">Share your question with the community and get expert answers</p>
        </motion.div>
                    ...
                    {steps.map((step, index) => (
                      <div key={step.label} className="flex items-center">
                        ...
                        <span className={`ml-3 text-sm font-medium ${
                          getStepStatus(index) === 'pending' ? 'text-gray-400' : 'text-gray-700'
                        }`}>
                          {step.label}
                        </span>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-8">
                    ...
                    >
                      ...
                      <div className="flex items-center justify-between text-sm">
                        ...
                        <span className={`${title.length >= 10 ? 'text-green-600' : 'text-gray-400'}`}>
                    ...
                    >
                      ...
                      <p className="text-sm text-gray-500">
                        Include code examples, error messages, and what you&#39;ve tried
                      </p>
                    </motion.div>
                    ...
                    >
                      ...
                      <div className="flex items-center justify-between text-sm">
                        <span className="text-gray-500">Help others find your question</span>
                        <span className={`${tags.length > 0 ? 'text-green-600' : 'text-gray-400'}`}>
              ...
              <Card className="shadow-lg bg-gradient-to-br from-indigo-50 to-purple-50 border-0">
                <CardContent className="p-6">
                  <div className="flex items-center space-x-2 mb-4">
                    ...
                    <h3 className="text-lg font-bold text-gray-800">Tips for Great Questions</h3>
                  </div>
              ...
              <Card className="shadow-lg">
                <CardContent className="p-6">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center justify-between">
                      <span className="text-sm text-gray-600">Expert Members</span>
                      <Badge className="bg-blue-100 text-blue-800">1.2k</Badge>
                    </div>
                  </div>
                </CardContent>
              </Card>
        ...
        {showSuccess && (
          ...
          >
            <div className="bg-white p-8 rounded-2xl shadow-2xl text-center max-w-md mx-4">
              ...
              <h3 className="text-2xl font-bold text-gray-800 mb-2">Question Submitted!</h3>
              <p className="text-gray-600">Your question has been posted successfully. The community will help you soon!</p>
            </div>
          </motion.div>
        )}
      </AnimatePresence>
